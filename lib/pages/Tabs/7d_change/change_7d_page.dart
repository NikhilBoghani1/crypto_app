...
class Change7dPage extends StatelessWidget {
  AssetsController assetsController = Get.find();
  Constants myConstants = Constants();

  Change7dPage({super.key});
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              height: Get.height * 0.50, // Set height as 65% of screen height
                      ...
                      return ListTile(
                        ...
                        trailing: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "${assetsController.coinData[index].values?.uSD?.percentChange7d?.toStringAsFixed(2) ?? "N/A"}%", // Add % sign and handle null
                              style: TextStyle(
                                fontSize: 13,
